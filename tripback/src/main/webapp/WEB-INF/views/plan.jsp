  ...
  <main id="main">
	...
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a89eda6c702665409c98e615cd2f9837&libraries=services,clusterer,drawing"></script>
            <script>
              ...
              document.querySelector("#button-addon1").addEventListener("click", choose1);
              function choose1() {
                var key = document.getElementById("place1").value;
                var p = temp[key];
                console.log(p);
                let str = `
                    <p>${p.place_name}</p>
                    <p>${p.road_address_name}</p>
                  `;
                document.getElementById("p1").setAttribute("style", "display:none");
                // document.getElementById("button-addon1").setAttribute("style", "display:none");
                // 자식 노드로 label 추가
                var target = document.getElementsByClassName("resume-item")[0];
                target.innerHTML += str;
              }

              document.querySelector("#button-addon2").addEventListener("click", choose2);
              function choose2() {
                var key = document.getElementById("place2").value;
                var p = temp[key];
                console.log(p);
                let str = `
                    <p>${p.place_name}</p>
                ...
                // 자식 노드로 label 추가
                var target = document.getElementsByClassName("resume-item")[1];
                target.innerHTML += str;
              }

              document.querySelector("#button-addon3").addEventListener("click", choose3);
              function choose3() {
                var key = document.getElementById("place3").value;
                var p = temp[key];
                console.log(p);
                let str = `
                    <p>${p.place_name}</p>
                ...
                // 자식 노드로 label 추가
                var target = document.getElementsByClassName("resume-item")[2];
                target.innerHTML += str;
              }
            </script>
          </div>
