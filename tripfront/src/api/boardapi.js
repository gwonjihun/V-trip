...
async function likeInsert(content_id, success, fail) {
  await api.get(`/board/${content_id}/like`).then(success).catch(fail);
}
async function likeSelect(content_id, success, fail) {
  await api.post(`/board/${content_id}/like`).then(success).catch(fail);
}
async function likeDelete(content_id, success, fail) {
  await api.delete(`/board/${content_id}/like`).then(success).catch(fail);
}
